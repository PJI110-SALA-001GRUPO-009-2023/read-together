...
export const AZURE_EMAIL_COMMS_SERVICE_KEY = process.env.AZURE_EMAIL_COMMS_SERVICE_KEY || ''
export const AZURE_EMAIL_COMMS_SERVICE_ENDPOINT = process.env.AZURE_EMAIL_COMMS_SERVICE_ENDPOINT || ''
